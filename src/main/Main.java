...
public class Main {
  static final boolean SAUTER_SELECTION_CARTE = false; // mettre a false pour avoir l'outil de selection de carte
  ...
  public static void main(String[] args) throws IOException {
    try {
      ...
      System.out.println(
        "Erreur lors de l'execution du jeu : " + e.getMessage()
      );
    }
  }
  ...
  private static String selectionCarte() throws IOException {
    try {
      SelecteurDeFichier selecteur = new SelecteurDeFichier(
        Chemins.getDossierCartes()
      );
