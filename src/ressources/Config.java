...
public class Config {
  /** 
 	...
 	*/
  public static final char[] TOUCHES_PERTINENTES_CARACTERES = {
    't',
    'a',
    'u',
    'j',
  ...
  protected static final Color COULEUR_ARRIERE_PLAN = Color.white;

  /** Nombre de pixels par case du jeu */
  private static final int PIXELS_PAR_CASE = 48;

  /** Marge sur les cotes, en pixels */
  private static final int PIXELS_MARGE = 20;

  /** Hauteur de la zone de texte, en pixels */
  private static final int PIXELS_HAUTEUR_ZONE_TEXTE = 50;

  /** Marge entre la zone de texte et la carte, en pixels */
  private static final int PIXELS_MARGE_TEXTE_CARTE = 50;

  /** Couleur du texte qui s'affiche au dessus de la carte */
  protected static final Color COULEUR_TEXTE_DESCRIPTIF = new Color(0, 0, 51);

  /** Place verticale occupee par chaque option dans la fenetre, en pixels */
  protected static final int PIXELS_PAR_ITEM_POPUP = 35;

  /** Couleur d'arriere-plan de la fenetre de popup */
  protected static final Color POPUP_COULEUR_ARRIERE_PLAN = new Color(
    255,
    255,
    230
  );
  ...
  protected static final Color POPUP_COULEUR_CADRE = new Color(120, 40, 0);

  /** Police par defaut, celle du texte au-dessus de la carte */
  protected static final Font POLICE_PAR_DEFAUT = new Font(
    Font.SANS_SERIF,
    Font.PLAIN,
    20
  );
  ...
  protected static final Font POLICE_POPUP = new Font("Arial", Font.BOLD, 16);

  /** Couleur du texte dans la fenetre de popup */
  protected static final Color POPUP_COULEUR_TEXTE = new Color(0, 0, 0);
  ...
  public static void setDimension(int nbCasesX, int nbCasesY) {
    ...
    nbPixelsY =
      (longueurCarteYCases * PIXELS_PAR_CASE) +
      2 *
      PIXELS_MARGE +
      PIXELS_HAUTEUR_ZONE_TEXTE +
      PIXELS_MARGE_TEXTE_CARTE;
    carteTailleX =
      (double) (longueurCarteXCases * PIXELS_PAR_CASE) / (double) nbPixelsX;
    carteTailleY =
      (double) (longueurCarteYCases * PIXELS_PAR_CASE) / (double) nbPixelsY;
