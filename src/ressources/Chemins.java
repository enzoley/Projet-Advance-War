...
public class Chemins {
  ...
  protected static final String CHEMIN_CURSEUR_POPUP =
    CHEMIN_RACINE + "pictures" + File.separator + "cursor_popup.png";
  ...
  protected static final String POPUP_CURSEUR =
    DOSSIER_IMAGES + File.separator + "cursor_popup.png";
  /** Dossier contenant les sprites des batiments */
  protected static final String DOSSIER_BATIMENTS =
    DOSSIER_IMAGES + File.separator + "buildings";
  /** Dossier contenant les sprites des terrains */
  protected static final String DOSSIER_TERRAINS =
    DOSSIER_IMAGES + File.separator + "terrains";
  /** Dossier contenant les sprites des unites */
  protected static final String DOSSIER_UNITES =
    DOSSIER_IMAGES + File.separator + "troops";
  /** Dossier contenant les sprites des fleche de deplacement */
  protected static final String DOSSIER_FLECHES =
    DOSSIER_IMAGES + File.separator + "arrows";
   ...
   */
  public static String getCheminUnite(
    int joueur,
    boolean disponible,
    String fichier
  ) {
